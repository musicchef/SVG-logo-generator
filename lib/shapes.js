...
class Triangle extends Shape {
    render() {
        ...
        const textY = halfSize + (this.size * 0.2); // Adjust the vertical position of the text
        const fontSize = Math.min(this.size * 0.22, 30); // Limit the font size to a maximum of 30
